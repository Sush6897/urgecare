...
Route::get('/blog/{slug}', [FrontendController::class, 'blogDetail'])->name('blogs.detail');
...
Route::get('/ambulance-service-in-pune', [FrontendController::class, 'ambulanceServiceInPune'])->name('ambulance.service.pune');
Route::get('/emergency-ambulance-service-in-pune', [FrontendController::class, 'emergencyAmbulanceServiceInPune'])->name('emergency.ambulance.pune');
Route::get('/private-ambulance-service-near-me', [FrontendController::class, 'privateAmbulanceServiceNearMe'])->name('private.ambulance.near.me');
Route::get('/train-ambulance-service-in-pune', [FrontendController::class, 'trainAmbulanceService'])->name('train.ambulance.pune');
Route::get('/air-ambulance-service-in-pune', [FrontendController::class, 'airAmbulanceService'])->name('air.ambulance.pune');
Route::get('/pune-ambulance-number-in-pune', [FrontendController::class, 'puneAmbulanceNumber'])->name('pune.ambulance.number');
Route::get('/icu-ambulance-service-in-pune', [FrontendController::class, 'icuAmbulanceService'])->name('icu.ambulance.pune');
