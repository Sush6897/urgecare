            ...
            <form action="{{ route('hospital.update', $hospital->id) }}" method="POST" >
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="features1" name="features[features1]" value="{{ old('features.features1', $hospital->features1 ?? '') }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="features2" name="features[features2]" value="{{ old('features.features2', $hospital->features2 ?? '') }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="features3" name="features[features3]" value="{{ old('features.features3', $hospital->features3 ?? '') }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="features4" name="features[features4]" value="{{ old('features.features4', $hospital->features4 ?? '') }}">
