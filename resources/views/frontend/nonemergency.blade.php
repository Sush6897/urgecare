...
@section('content')
<section class="search-non-emergency py-5">
  <div class="container">
    <div class="row">
      <div class="col-12">
...
<script>
  ...
  // Initial check if load more should be visible
  ...
  $('#bookNowModal').on('show.bs.modal', function (event) {
      ...
      if (lat) modal.find('#modal_latitude').val(lat);
      if (lng) modal.find('#modal_longitude').val(lng);
