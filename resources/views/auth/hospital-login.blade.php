...
<head>
        ...
        <title>Urgecare - Hospital Login</title>
                	...
                	<div class="loginbox">
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<p class="account-subtitle">Access your hospital portal</p>
								...
								<div class="text-center forgotpass"><a href="{{route('hospital.forget.password')}}">Forgot Password?</a></div>
