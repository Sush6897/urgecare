                	...
                	<div class="loginbox">
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<p class="account-subtitle">Enter your email to get a password reset link for Hospital Portal</p>
								
								<!-- Form -->
								<form action="{{route('hospital.forget.password.submit')}}" method="POST">
                                    @csrf
								...
								<div class="text-center dont-have">Remember your password? <a href="{{route('hospital.login')}}">Login</a></div>
							</div>
                        </div>
                    </div>
                </div>
